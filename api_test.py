...
def add():
  ...
  g.cursor.execute("INSERT INTO api.servermonitor (sistema, hostname, percentual_memoria, percentual_cpu, percentual_disco, carga) VALUES (%s,%s)", (req_json['sistema'], req_json['hostname'], (req_json['percentual_memoria'],, req_json['percentual_cpu'], (req_json['percentual_disco'],, (req_json['carga']))
  g.conn.commit()
