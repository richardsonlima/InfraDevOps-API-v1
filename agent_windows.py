...
data = json.dumps({"sistema": platform.system(), "hostname": socket.gethostname(), "percentual_memoria": ram_percent_used, "percentual_cpu": cpu_usage, "percentual_disco": disk_percent_used, "carga": "carga" })
